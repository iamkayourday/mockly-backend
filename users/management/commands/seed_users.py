...
from users.models import MockUser

class Command(BaseCommand):
    help = "Seed mock users data for Mockly"
    ...
    def handle(self, *args, **options):
        ...
        for data in mock_users:
            _, is_created = MockUser.objects.get_or_create(
                email=data["email"],
                defaults=data,
            )
            if is_created:
        ...
        self.stdout.write(
            self.style.SUCCESS(f"✅ Successfully seeded {created} mock users")
        )
